											...
											<li>
												<div class="tg-result">
													<span class="tg-counting"><?php 
														...
														$count++;
													?></span>
													<div class="tg-description"><p><a href="cardpage.php?term=<?php echo $rowValue['term']; ?>&sessions=<?php echo $rowValue['sessions']; ?>&class=<?php echo $rowValue['classes']; ?>&studentname=<?php echo $rowValue['studentname']; ?>"><?php echo strtoupper($rowValue['studentname']); ?></a></p></div>
												</div>
											</li>
