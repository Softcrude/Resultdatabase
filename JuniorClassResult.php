...
$pinmsg = '';
		...
		$sqlcomputeNoInClass = "SELECT * FROM computedresult WHERE class = '$classes' AND term = '$term' AND session = '$sessions'";
    ...
    <td><table width="100%" border="0">
      ...
      <tr>
        <td><table width="100%" border="1" align="center">
          ...
          <tr>
            <td align="center"><strong>English Lang/Lit.</strong></td>
          ...
          <tr>
            <td align="center"><strong>Agric Sci./Fishery</strong></td>
