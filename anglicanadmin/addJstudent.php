...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if($studentname  == '' || $jss == '' || $abc == '' || $sessions == '' || $term == ''|| $noofsubjects == '' || $sex == ''){
		...
		$sql1 = "SELECT * FROM jstudentsexamsrecordtb WHERE studentname = '$studentname' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1";
		...
		if($rowNumber1 == 1){
				...
				$xsn = 0;
				$sql22 = "INSERT INTO jstudentsexamsrecordtb VALUES('$xsn','$studentname','$sex','$classes','$term','$sessions','$noofsubjects',NOW())";
				mysqli_query($link,$sql22) or die(mysqli_error($link));
	
				$zero = 0;
				$nograde = '';
				$sqlenglish = "INSERT INTO jenglish VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlenglish) or die(mysqli_error($link));
	
				$sqlmaths = "INSERT INTO jmaths VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlmaths) or die(mysqli_error($link));
	
	
				$sqlagric = "INSERT INTO jagric VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlagric) or die(mysqli_error($link));
	
				$sqlbasicsci = "INSERT INTO jbasicsci VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlbasicsci) or die(mysqli_error($link));
	
				$sqlbasictech = "INSERT INTO jbasictech VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlbasictech) or die(mysqli_error($link));
	
				$sqlbusinessstd = "INSERT INTO jbusinessstd VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlbusinessstd) or die(mysqli_error($link));
	
				$sqlcca = "INSERT INTO jcca VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlcca) or die(mysqli_error($link));
	
				$sqlcivicedu = "INSERT INTO jcivicedu VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlcivicedu) or die(mysqli_error($link));
	
				$sqlcomputer = "INSERT INTO jcomputer VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlcomputer) or die(mysqli_error($link));
	
				$sqlcrs = "INSERT INTO jcrs VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlcrs) or die(mysqli_error($link));
	
				$sqlfrench = "INSERT INTO jfrench VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlfrench) or die(mysqli_error($link));
	
				$sqlfishery = "INSERT INTO jfishery VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlfishery) or die(mysqli_error($link));
	
				$sqlhomec = "INSERT INTO jhomec VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlhomec) or die(mysqli_error($link));
	
				$sqligbo = "INSERT INTO jigbo VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqligbo) or die(mysqli_error($link));
	
				$sqlliterature = "INSERT INTO jliterature VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlliterature) or die(mysqli_error($link));
	
				$sqlphyedu = "INSERT INTO jphyedu VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlphyedu) or die(mysqli_error($link));
	
	
				$sqlsocialstd = "INSERT INTO jsocialstd VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	mysqli_query($link,$sqlsocialstd) or die(mysqli_error($link));
	
				$sqlphy= "INSERT INTO jmusic VALUES('$xsn','$studentname','$classes','$term','$sessions','$zero','$zero','$zero','$nograde',NOW())";
	...
	$_SESSION['noofsubjects'] = $noofsubjects;
			...
			header('Location:addJStudentsuccess.php');
			}
