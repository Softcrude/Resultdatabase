		...
		if($msg == ''){
				...
				if($classSubString == 'JSS'){
					...
					if($rowNumber17 > 0){
						...
						$sql171 = "DELETE FROM computedresult WHERE class = '$classes' AND term = '$term' AND session = '$sessions'";
						$query171 = mysqli_query($link,$sql171) or die(mysqli_error($link));
						//$rowValue17 = mysqli_fetch_assoc($query17);
						//$rowNumber17 = mysqli_num_rows($query17);
					...
					if($rowNumber17 > 0){
						...
						$sql171 = "DELETE FROM scomputedresult WHERE class = '$classes' AND term = '$term' AND session = '$sessions'";
						$query171 = mysqli_query($link,$sql171) or die(mysqli_error($link));
						//$rowValue17 = mysqli_fetch_assoc($query17);
						//$rowNumber17 = mysqli_num_rows($query17);
						$msg = 'Result Reset Done Successfully';
