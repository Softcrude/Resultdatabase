		...
		if($msg == ''){
		  ...
		  if($classSubString == 'JSS'){		
			...
			if($rowNumber17 > 0){
				...
				$msg = 'Result For The Selected Class is NOT Computed.';
...
<input type="checkbox" class="js-switch" data-size="small" />
	...
	<div class="content">
		<h2 class="content-heading">View Computed  Results</h2>
		...
		<div class="row"> 
			<div class="col-12">
				...
				<!-- Examples -->
				<div class="card">
					<div class="card-header">Select Class To View</div>
					<div class="card-body">
                        ...
                        <table id="example1" class="table table-striped">
								...
								<tr>
									...
									<td>&nbsp;</td>
									<td colspan="2">&nbsp;</td>
									<td><input type="submit" name="view" id="view" value="View Computed Result"></td>
								</tr>
								<tr>
								  <td>&nbsp;</td>
								  <td>&nbsp;</td>
