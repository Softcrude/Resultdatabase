...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		$sql1 = "SELECT * FROM jstudentsexamsrecordtb WHERE classes = '$classes' AND term = '$term' AND sessions = '$sessions'";
		...
		if($rowNumber1 > 0){
			...
			do{
				...
				$sqljmaths = "SELECT (( select sum(totalscore) from jmaths where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1) + ( select sum(totalscore) from jenglish where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jagric where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jbasicsci where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jbasictech where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jbusinessstd where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jcca where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jcivicedu where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jcomputer where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jcrs where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jfishery where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jfrench where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jhomec where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jigbo where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jliterature where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jphyedu where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jsocialstd where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)+ ( select sum(totalscore) from jmusic where studentname = '$name' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions' LIMIT 1)) as 'total'";
				...
				$rowValue13 = mysqli_fetch_assoc($queryjmaths);
					...
					mysqli_query($link,"INSERT INTO `computedresult` (`sn`, `studentname`, `class`, `term`, `session`,`noofsubjects`, `totalscore`, `average`, `dateadded`) VALUES ('$sn', '$name', '$classes', '$term', '$sessions', '$noofsubjects', '$total', '$avg', NOW())") or die(mysqli_error($link));
				...
				while($rowValue1 = mysqli_fetch_assoc($query1));
					...
					$sqlrank = "SELECT * FROM computedresult WHERE class = '$classes' AND term = '$term' AND session = '$sessions' ORDER BY average DESC";
					...
					$grades = array();
						...
						$grades = array_unique($grades);
							foreach($grades as $grade) {
								 ...
								 $sqlrank = "UPDATE computedresult SET positions = '$pos' WHERE average = '$grade' ORDER BY average DESC";
								 mysqli_query($link,$sqlrank) or die(mysqli_error($link));	
								 
    							$i += $occurrences[$grade];
								
								 $sqlranks = "SELECT * FROM computedresult WHERE positions LIKE '%$pos%'";
		...
		$sqlD = "SELECT * FROM computedresult WHERE class = '$classes' AND term = '$term' AND session = '$sessions'";
...
<input type="checkbox" class="js-switch" data-size="small" />
	...
	<div class="content">
		<h2 class="content-heading">Compute Junior Student's  Result</h2>
