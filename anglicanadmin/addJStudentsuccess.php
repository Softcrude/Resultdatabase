...
<input type="checkbox" class="js-switch" data-size="small" />
	...
	<div class="content">
		<h2 class="content-heading">Student Added Successfully</h2><!-- Page title -->
	  ...
	  <div class="row">
			<div class="col-12">
				...
				<!-- Blockquotes -->
				<div class="card">
					<div class="card-header">Result Added Successfully</div>
					<div class="card-body">
					  <blockquote class="blockquote-reverse">
					    <p>Junior Student Added Successfully</p>
							<footer><?php echo '<a href="addJstudent.php">Go Back</a>'; ?></footer>
						</blockquote>
