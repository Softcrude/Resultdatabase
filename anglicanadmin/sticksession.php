...
if(!isset($_SESSION['key'])){
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		$sql = "UPDATE sessiontb SET session = '$sessions', dateupdated = NOW() WHERE sn = 1";
		$query = mysqli_query($link,$sql) or die(mysqli_error($link));
		$msg = 'Done';
...
<input type="checkbox" class="js-switch" data-size="small" />
	...
	<div class="content">
		<h2 class="content-heading">Stick Session</h2>
		...
		<div class="row"> 
			<div class="col-12">
                ...
                <div class="card-header"><font color="#990000"><?php echo $msg; ?></font></div>
					<div class="card-header">Stick To a Session</div>
					<div class="card-body">

						<form action="" method="post">
                        <table id="example1" class="table table-striped">
								<tr>
									<td width="15%"><strong>Select Session:</strong></td>
									<td width="28%"><strong>
									...
									<td width="24%">&nbsp;</td>
									<td width="11%">&nbsp;</td>
									<td width="16%"><input type="submit" name="stick" id="stick" value="Stick Session"></td>
								</tr>
								<tr>
