	...
	if($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if($rowNumber1 > 0){
				...
				do{
					...
					$studentlist .= '<tr>
								      <td align="center">'.$rowValue1['studentname'].'</td>
								      <td align="center">'.$rowValue1['classes'].'</td>
								      <td align="center">'.$rowValue1['term'].'</td>
								      <td align="center">'.$rowValue1['sessions'].'</td>
								      <td align="center"><a href="sResultUpdate.php?sname='.$rowValue1['studentname'].'&class='.$rowValue1['classes'].'&term='.$rowValue1['term'].'&sessions='.$rowValue1['sessions'].'">Update Result</a></td>
							        </tr>';
...
//////////////////////////////////GET///////////////////
	...
	if(isset($_GET['class']) && isset($_GET['sessions']) && isset($_GET['term'])){
...
<input type="checkbox" class="js-switch" data-size="small" />
	...
	<div class="content">
		<h2 class="content-heading">View Junior Student's  Result List</h2>
					...
					<div class="card-body">
                        ...
                        <table id="example1" class="table table-striped">
								...
								<tr>
									...
									<td>&nbsp;</td>
									<td colspan="2">&nbsp;</td>
									<td><input type="submit" name="view" id="view" value="View Class List"></td>
								</tr>
								<tr>
								  <td>&nbsp;</td>
								  <td>&nbsp;</td>
								...
								<tr>
								  <td colspan="6" align="center"><table width="100%" border="1">
								    <tr>
								      ...
								      <td width="15%" align="center"><strong>Activity</strong></td>
							        </tr>
