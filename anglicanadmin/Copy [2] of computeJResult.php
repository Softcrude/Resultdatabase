		...
		if($rowNumber1 > 0){
			...
			do{
				...
				$rowValue13 = mysqli_fetch_assoc($queryjmaths);
					...
					mysqli_query($link,"INSERT INTO `computedresult` (`sn`, `studentname`, `class`, `term`, `session`, `totalscore`, `average`, `dateadded`) VALUES ('$sn', '$name', '$classes', '$term', '$sessions', '$total', '$avg', NOW())") or die(mysqli_error($link));
								...
								<tr>
								  <td colspan="6" align="center"><table width="100%" border="1">
								    <tr>
								      ...
								      <td width="15%" align="center"><strong>Position</strong></td>
							        </tr>
