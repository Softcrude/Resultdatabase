...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if (confirm('Result Already Computed. <br>Do you want to remove the old record?')) {
    document.location = delUrl;
  }
  else{
	  document.location = 'computeJResult.php';
	  
	  }
}
</script>";
				
               echo "<script type='text/javascript'>confirmDelete('index.php');</script>"; */
		...
		if($rowNumber1 > 0){
			...
			do{
				...
				$rowValue13 = mysqli_fetch_assoc($queryjmaths);
					...
					mysqli_query($link,"INSERT INTO `scomputedresult` (`sn`, `studentname`, `class`, `term`, `session`, `totalscore`, `average`, `dateadded`) VALUES ('$sn', '$name', '$classes', '$term', '$sessions', '$total', '$avg', NOW())") or die(mysqli_error($link));
                        ...
                        <table id="example1" class="table table-striped">
								...
								<tr>
								  <td colspan="6" align="center"><table width="100%" border="1">
								    <tr>
								      <td width="34%" align="center"><strong>Students Name</strong></td>
								      <td width="16%" align="center"><strong>Class</strong></td>
								      <td width="19%" align="center"><strong>Term</strong></td>
								      <td width="16%" align="center"><strong>Session</strong></td>
								      <td width="15%" align="center"><strong>Average</strong></td>
							        </tr>
								    ...
								    <tr>
								      ...
								      <td align="center"><?php echo $rowValueD['average']; ?></td>
							        </tr>
