...
<input type="checkbox" class="js-switch" data-size="small" />
	...
	<div class="content">
		<h2 class="content-heading">Result Updated Successfully</h2><!-- Page title -->
	  ...
	  <div class="row">
			<div class="col-12">
				...
				<!-- Blockquotes -->
				<div class="card">
					<div class="card-header">Result Updated Successfully</div>
					<div class="card-body">
					  <blockquote class="blockquote-reverse">
					    <p>Senior Class Result Updated Successfully</p>
							<footer><?php echo '<a href="updateSResult.php?class='.$classes.'&term='.$term.'&sessions='.$sessions.'">Go Back</a>'; ?></footer>
						</blockquote>
...
<!-- Mirrored from html.alfisahr.com/prudence/typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Nov 2017 08:30:23 GMT -->
</html>