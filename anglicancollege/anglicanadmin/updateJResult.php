		...
		if($rowNumber1 > 0){
				...
				do{
					...
					$studentlist .= '<tr>
								      ...
								      <td align="center"><a href="jResultUpdate.php?sname='.$rowValue1['studentname'].'&class='.$rowValue1['classes'].'&term='.$rowValue1['term'].'&sessions='.$rowValue1['sessions'].'">Update Result</a></td>
							        </tr>';
