								...
								<tr>
									<td colspan="6" align="center"><table width="100%" border="0">
                                      ...
                                      <tr>
									    ...
									    <td align="center"><label>
									      <input type="text" name="acctCA" id="acctCA" class="txtMarksACCT" autocomplete="off"  value="<?php echo $rowValueacct['cascore']; ?>">
									      </label></td>
									    <td align="center"><input type="text" name="acctExam" id="acctExam" class="txtMarksACCT" autocomplete="off" value="<?php echo $rowValueacct['examscore']; ?>"></td>
									    <td align="center"><input name="acctTotal" type="text" id="acctTotal" readonly="readonly" value="<?php echo $rowValueacct['totalscore']; ?>"></td>
									    <td align="center"><input name="acctGrade" type="text" id="acctGrade" readonly="readonly" value="<?php echo $rowValueacct['grade']; ?>"></td>
								      </tr>
                                      <tr>
                                      ...
                                      <tr>
									    ...
									    <td align="center"><label>
									      <input type="text" name="phyCA" id="phyCA" class="txtMarksPHY" autocomplete="off"  value="<?php echo $rowValuephy['cascore']; ?>">
									      </label></td>
									    <td align="center"><input type="text" name="phyExam" id="phyExam" class="txtMarksPHY" autocomplete="off" value="<?php echo $rowValuephy['examscore']; ?>"></td>
									    <td align="center"><input name="phyTotal" type="text" id="phyTotal" readonly="readonly" value="<?php echo $rowValuephy['totalscore']; ?>"></td>
									    <td align="center"><input name="phyGrade" type="text" id="phyGrade" readonly="readonly" value="<?php echo $rowValuephy['grade']; ?>"></td>
								      </tr>
                                      <tr>
									    <td align="center">Chemistry</td>
									    <td align="center"><label>
									      <input type="text" name="chemCA" id="chemCA" class="txtMarksCHEM" autocomplete="off"  value="<?php echo $rowValuechem['cascore']; ?>">
									      </label></td>
									    <td align="center"><input type="text" name="chemExam" id="chemExam" class="txtMarksCHEM" autocomplete="off" value="<?php echo $rowValuechem['examscore']; ?>"></td>
									    <td align="center"><input name="chemTotal" type="text" id="chemTotal" readonly="readonly" value="<?php echo $rowValuechem['totalscore']; ?>"></td>
									    <td align="center"><input name="chemGrade" type="text" id="chemGrade" readonly="readonly" value="<?php echo $rowValuechem['grade']; ?>"></td>
								      </tr>
                                      <tr>
                                      ...
                                      <tr>
									    ...
									    <td align="center"><label>
									      <input type="text" name="bioCA" id="bioCA" class="txtMarksBIO" autocomplete="off"  value="<?php echo $rowValuebio['cascore']; ?>">
									      </label></td>
									    <td align="center"><input type="text" name="bioExam" id="bioExam" class="txtMarksBIO" autocomplete="off" value="<?php echo $rowValuebio['examscore']; ?>"></td>
									    <td align="center"><input name="bioTotal" type="text" id="bioTotal" readonly="readonly" value="<?php echo $rowValuebio['totalscore']; ?>"></td>
									    <td align="center"><input name="bioGrade" type="text" id="bioGrade" readonly="readonly" value="<?php echo $rowValuebio['grade']; ?>"></td>
								      </tr>
                                      <tr>
									    <td align="center">Economics</td>
									    <td align="center"><label>
									      <input type="text" name="econsCA" id="econsCA" class="txtMarksEcons" autocomplete="off"  value="<?php echo $rowValueecons['cascore']; ?>">
									      </label></td>
									    <td align="center"><input type="text" name="econsExam" id="econsExam" class="txtMarksEcons" autocomplete="off" value="<?php echo $rowValueecons['examscore']; ?>"></td>
									    <td align="center"><input name="econsTotal" type="text" id="econsTotal" readonly="readonly" value="<?php echo $rowValueecons['totalscore']; ?>"></td>
									    <td align="center"><input name="econsGrade" type="text" id="econsGrade" readonly="readonly" value="<?php echo $rowValueecons['grade']; ?>"></td>
								      </tr>
                                      <tr>
                                      ...
                                      <tr>
									    ...
									    <td align="center"><label>
									      <input type="text" name="govtCA" id="govtCA" class="txtMarksGOVT" autocomplete="off"  value="<?php echo $rowValuegovt['cascore']; ?>">
									      </label></td>
									    <td align="center"><input type="text" name="govtExam" id="govtExam" class="txtMarksGOVT" autocomplete="off" value="<?php echo $rowValuegovt['examscore']; ?>"></td>
									    <td align="center"><input name="govtTotal" type="text" id="govtTotal" readonly="readonly" value="<?php echo $rowValuegovt['totalscore']; ?>"></td>
									    <td align="center"><input name="govtGrade" type="text" id="govtGrade" readonly="readonly" value="<?php echo $rowValuegovt['grade']; ?>"></td>
								      </tr>
                                      <tr>
									    <td align="center">Food &amp; Nutrition</td>
									    <td align="center"><label>
									      <input type="text" name="fnutCA" id="fnutCA" class="txtMarksFNUT" autocomplete="off"  value="<?php echo $rowValuefnut['cascore']; ?>">
									      </label></td>
									    <td align="center"><input type="text" name="fnutExam" id="fnutExam" class="txtMarksFNUT" autocomplete="off" value="<?php echo $rowValuefnut['examscore']; ?>"></td>
									    <td align="center"><input name="fnutTotal" type="text" id="fnutTotal" readonly="readonly" value="<?php echo $rowValuefnut['totalscore']; ?>"></td>
									    <td align="center"><input name="fnutGrade" type="text" id="fnutGrade" readonly="readonly" value="<?php echo $rowValuefnut['grade']; ?>"></td>
								      </tr>
                                      <tr>
                                      ...
                                      <tr>
									    ...
									    <td align="center"><label>
									      <input type="text" name="geoCA" id="geoCA" class="txtMarksGEO" autocomplete="off"  value="<?php echo $rowValuegeo['cascore']; ?>">
									      </label></td>
									    <td align="center"><input type="text" name="geoExam" id="geoExam" class="txtMarksGEO" autocomplete="off" value="<?php echo $rowValuegeo['examscore']; ?>"></td>
									    <td align="center"><input name="geoTotal" type="text" id="geoTotal" readonly="readonly" value="<?php echo $rowValuegeo['totalscore']; ?>"></td>
									    <td align="center"><input name="geoGrade" type="text" id="geoGrade" readonly="readonly" value="<?php echo $rowValuegeo['grade']; ?>"></td>
								      </tr>
									  <tr>
									    <td align="center">Animal Husbandry</td>
									    <td align="center"><label>
									      <input type="text" name="anihusCA" id="anihusCA" class="txtMarksAH" autocomplete="off"  value="<?php echo $rowValueanihus['cascore']; ?>">
									      </label></td>
									    <td align="center"><input type="text" name="anihusExam" id="anihusExam" class="txtMarksAH" autocomplete="off" value="<?php echo $rowValueanihus['examscore']; ?>"></td>
									    <td align="center"><input name="anihusTotal" type="text" id="anihusTotal" readonly="readonly" value="<?php echo $rowValueanihus['totalscore']; ?>"></td>
									    <td align="center"><input name="anihusGrade" type="text" id="anihusGrade" readonly="readonly" value="<?php echo $rowValueanihus['grade']; ?>"></td>
								      </tr>
									  <tr>
