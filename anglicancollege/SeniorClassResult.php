...
$pinmsg = '';
		...
		$sqlanihus = "SELECT * FROM sfoodnut WHERE studentname = '$studentname' AND classes = '$classes' AND term = '$term' AND sessions = '$sessions'";
      ...
      <tr>
        <td><table width="100%" border="1" align="center">
          ...
          <tr>
            ...
            <td align="center">&nbsp;</td>
            <td colspan="3" align="center"><strong>Name of Principal :</strong><em> <strong><font color="#006699">Mrs Ajuzie E.U</font></strong></em></td>
            </tr>
          <tr>
            ...
            <td align="center">&nbsp;</td>
            <td colspan="3" rowspan="2" align="center"><img src="images/signature2.png" width="101" height="43" alt="" /></td>
            </tr>
          <tr>
            <td align="center">&nbsp;</td>
            <td align="center">&nbsp;</td>
